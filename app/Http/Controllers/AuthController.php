...
class AuthController extends Controller
{
    ...
    public function processForgotPassword (Request $request) { 
        ...
        if ($validator->fails()) {
            ...
            'token' => $token,
            'user' => $user,
            'mailSubject' => 'Kamu meminta untuk reset kata sandi'
        ];
            Mail::to($request->email) ->send(new ResetPasswordEmail($formData));

         return redirect()->route('front.forgotPassword')->with('success','Cek inbox untuk reset kata sandi kamu');
        //return redirect()->route('front.resetPassword', ['token' => $token])->with('success', 'Cek inbox untuk reset kata sandi kamu');
    ...
    public function processResetPassword (Request $request){
        ...
        return redirect()->route('account.login')->with('success', 'Kamu berhasil mengubah kata sandi');
