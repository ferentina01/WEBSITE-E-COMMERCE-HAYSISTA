                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select name="status" id="status" class="form-control">
                                        ...
                                        <option {{ ($subCategory->status == 0) ? 'selected' : ''}} value="2">block</option>
                                    </select>
                                    <p></p>
                                </div>
                            </div>
...
@section('content')
    ...
    <section class="content">
        <!-- Default box -->
        <div class="container-fluid">
            <form action="{{ route('sub-categories.update', $subCategory->id) }}" name="subCategoryForm" id="subCategoryForm">
                @csrf
                @method('PUT')
                <div class="card">
                    <div class="card-body">
