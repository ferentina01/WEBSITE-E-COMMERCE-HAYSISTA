    ...
    <section class="content">
        ...
        <div class="container-fluid">
            <form action="" method="post" id="editBrandForm" name="editBrandForm">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select name="status" id="status" class="form-control">
                                        ...
                                        <option {{ $brand->status == 0 ? 'selected' : '' }} value="2">Blokir
                                        </option>
                                    </select>
                                    <p></p>
                                </div>
                ...
                <div class="pb-5 pt-3">
                    <button type="submit" class="btn btn-primary">Update Merek baru</button>
                    <a href="{{ route('brands.index') }}" class="btn btn-outline-dark ml-3">Batalkan</a>
                </div>
            </form>
        </div>
        <!-- /.card -->
