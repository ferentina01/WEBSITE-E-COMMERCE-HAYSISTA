        ...
        <div class="container-fluid">
            ...
            <form action="" method="post" id="usersForm" name="usersForm">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input value="{{ $user->sandi }}"  type="text"  name="password" id="password" class="form-control"
                                        placeholder="password">
                                        <span>Untuk mengubah kata sandi kamu harus memasukan nilai, jika tidak biarkan kosong</span>
                                    <p></p>
                                </div>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select
                                     type="text"  name="status" id="status" class="form-control">
                                        <option {{ ($user->status == 1) ? 'selected' : ''}} value="1">Aktif</option>
                                        <option {{ ($user->status == 0) ? 'selected' : ''}} value="0">Blokir</option>
                                    </select>
                                    <p></p>
                                </div>
                            </div>
                ...
                <div class="pb-5 pt-3">
                    ...
                    <a href="{{ route('users.index') }}" class="btn btn-outline-dark ml-3">Kembali</a>
                </div>
            </form>
        </div>
        <!-- /.card -->
