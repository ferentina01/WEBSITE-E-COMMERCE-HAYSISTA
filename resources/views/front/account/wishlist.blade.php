        ...
        <div class="container">
            <div class="light-font">
                <ol class="breadcrumb primary-color mb-0">
                    ...
                    <li class="breadcrumb-item">Wishlist Saya</li>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body p-4">
                            @if ($wishlists->isNotEmpty())
                                @foreach ($wishlists as $wishlist)
                                    <div class="d-sm-flex justify-content-between mt-lg-4 mb-4 pb-3 pb-sm-2 border-bottom">
                                        <div class="d-block d-sm-flex align-items-start text-center text-sm-start">
                                            ...
                                            <div class="pt-2">
                                                <h3 class="product-title fs-base mb-2"><a href="{{ route("front.product",$wishlist->product->slug) }}">
                                                        {{ $wishlist->product->title }}</a></h3>
                                                <div class="fs-lg text-accent pt-2">
                                                    <span class="h5"><strong>Rp
                                                            {{ number_format($wishlist->product->price, 0, ',', '.') }}</strong></span>
                                                    @if ($wishlist->product->compare_price > 0)
                                                        <span class="h6 text-underline"><del>Rp
                                                                {{ number_format($wishlist->product->compare_price, 0, ',', '.') }}</del></span>
                                                    @endif
                                ...
                                @else
                                <div>
                                    <h3 class="h5">Wishlist kamu Masing Kosong</h3>
                                </div>
