                ...
                <div class="col-md-9">
                    <div class="card">
                        <div class="card-header">
                            <h2 class="h5 mb-0 pt-2 pb-2">Ubah Sandi</h2>
                        </div>
                        <form action="{{ route('account.processChangePassword') }}" method="post" id="changePasswordForm"
                                ...
                                <div class="row">
                                    <div class="mb-3">
                                        ...
                                        <input type="password" name="old_password" id="old_password"
                                            placeholder="Masukkan Sandi Lama" class="form-control">
                                        <p></p>
                                    </div>
                                    <div class="mb-3">
                                        <label for="name">Sandi Baru</label>
                                        <input type="password" name="new_password" id="new_password"
                                            placeholder="Masukkan Sandi Baru" class="form-control">
                                        <p></p>
                                    </div>
                                    <div class="mb-3">
                                        <label for="name">Konfirmasi Sandi</label>
                                        <input type="password" name="confirm_password" id="confirm_password"
                                            placeholder="Masukkan Konfirmasi Sandi" class="form-control">
                                        <p></p>
                                    </div>
                                    <div class="d-flex">
                                        <button id="submit" name="submit" class="btn btn-dark">Simpan</button>
                                    </div>
                                </div>
                            </div>
                        </form>
