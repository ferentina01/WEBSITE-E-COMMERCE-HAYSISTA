        ...
        <div class="container">
            ...
            <div class="login-form">    
                <form action=""  method="post" name="registrationForm" id="registrationForm">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" placeholder="No. Handphone" id="phone" name="phone">
                        <p></p>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <input type="password" class="form-control" placeholder="Konfirmasi sandi" id="password_confirmation" name="password_confirmation">
                        <p></p>
                    </div>
                ...
                <div class="text-center small">Sudah Punya Akun? <a href="{{ route("account.login") }}">Masuk Sekarang</a></div>
            </div>
        </div>
    </section>
