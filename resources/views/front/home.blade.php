            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3">
                            <h1 class="display-4 text-white mb-3">Fashion Anak</h1>
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3">
                            <h1 class="display-4 text-white mb-3">Fashion Wanita</h1>
                            <p class="mx-md-5 px-5">Lorem rebum magna amet lorem magna erat diam stet. Sadips duo stet amet amet ndiam elitr ipsum diam</p>
                            <a class="btn btn-outline-light py-2 px-4 mt-3" href="#">Belanja Sekarang</a>
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 ">
                    <div class="box shadow-lg">
                        ...
                        <h2 class="font-weight-semi-bold m-0">Bebas Biaya Kirim</h2>
                    </div>                    
                </div>
                <div class="col-lg-3">
                    <div class="box shadow-lg">
                ...
                <div class="col-lg-3 ">
                    <div class="box shadow-lg">
                        ...
                        <h2 class="font-weight-semi-bold m-0">Dukungan 24/7</h5>
                    </div>                    
                </div>
            </div>
        </div>
		...
		<div class="row">
			<div class="col-md-4">
				<div class="footer-card">
					<h3>Kontak</h3>
					<p>Jl.Pinangranti Timur No.40 <br>
					13560, Makasar, Jakarta Timur <br>
					feren@gmail.com <br>
					0858 8020 1215</p>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-12 mt-3">
					<div class="copy-right text-center">
						<p>© Copyright 2024 Haysista Shop. All Rights Reserved</p>
					</div>
				</div>
			</div>
		</div>
