            ...
            <div class="row">
                ...
                @if (Cart::count() > 0)
                                            ...
                                            <td class="text-start">
                                                <div class="d-flex align-items-center ">
                                                    @if (!empty($item->options->productImage->image))
                                                        <img
                                                            src="{{ asset('uploads/product/' . $item->options->productImage->image) }}" />
                                                    @else
                                                        No Image Found
                                                    @endif
                    ...
                    <div class="col-md-4">
                        ...
                        <button class="btn btn-dark" type="button" id="button-addon2">Masukkan Kupon</button>
                    </div>  --}}
                    </div>
                @else
                    <div class="col-md-12">
...
@section('customJs')
    <script>
        ...
        function deleteItem(rowId) {
            if (confirm("Apa kamu yakin untuk menghapusnya?")) {
                $.ajax({
